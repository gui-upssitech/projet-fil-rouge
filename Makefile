...
test_display_console: src/test_display_console.c src/console.c inc/console.h src/toolbox.c inc/toolbox.h
	gcc -c src/toolbox.c -Wall
	gcc -c src/console.c -Wall
	gcc -c src/test_display_console.c -Wall
	mv ./*.o ./obj
	gcc -o ./app/test_display_console.out ./obj/test_display_console.o ./obj/console.o ./obj/toolbox.o