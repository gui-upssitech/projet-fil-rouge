...
void affect_unit(Unit_u* unit1, Unit_u unit2, Descriptor_e descriptor_type)
{
    ...
    switch(descriptor_type)
    {
        ...
        case AUDIO:
            ...
            unit1->audio_descriptor.p_histogram = (unsigned int*) malloc(100 * G_parameters.audio_indexing_parameters.levels * G_parameters.audio_indexing_parameters.samples * sizeof(unsigned int));
